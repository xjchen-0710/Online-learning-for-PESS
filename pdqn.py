...
class QActor(nn.Module):
	...
	def __init__(self, state_size, action_size, action_parameter_size, hidden_layers=(100,), action_input_layer=0,
		...
		if hidden_layers is not None:
			...
			# self.layers.append(nn.LSTM(inputSize, hidden_layers[0]))
			for i in range(1, nh):
				self.layers.append(nn.Linear(hidden_layers[i - 1], hidden_layers[i]))
				# self.layers.append(nn.LSTM(hidden_layers[i - 1], hidden_layers[i]))
...
class PDQNAgent(Agent):
	...
	def _optimize_td_loss(self):
		...
		# print("y_predicted: ", y_predicted, "y_expected: ", y_expected)
		# print("Loss_Q: ", loss_Q)
		...
		# print("weight: ")
		# print(self.actor_param_target.layers[i].weight for i in range(0, len(self.actor_param_target.layers)))
		...
		# print("actor param weight data: ", self.actor_param.layers[0].weight.data)
